...
<head>
    ...
    <link href="{$docroot}static/css/base/login.css?v={$cssversion}" type="text/css" rel="Stylesheet"/>
...
<div id="login" class="clearfix" style="margin-top: 100px">
    <div class="login-form" id="login-frame" style="width: 500px;">
        ...
        {elseif $settings.admin_setting_icon eq ''}
            <img src="{$docroot}static/images/login/profle_1.png"/>
        {/if}
...
<script type="text/javascript" src="{$docroot}static/script/spin.min.js?v={$cssversion}"></script>
<script type="text/javascript" src="{$docroot}static/script/base/login.js?v={$cssversion}"></script>
</body>
</html>