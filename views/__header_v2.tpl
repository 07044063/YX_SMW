...
<head>
    ...
    <link rel="Stylesheet" type="text/css"
          href="{$docroot}static/script/lib/umeditor/themes/default/css/umeditor.min.css"/>
    <link rel="Stylesheet" type="text/css" href="{$docroot}static/fontaswsome/css/font-awesome.min.css"/>
    <link rel="stylesheet" type="text/css" href="{$docroot}static/script/lib/select2/select2.min.css">
</head>
<body>